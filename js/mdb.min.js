jQuery.easing.jswing = jQuery.easing.swing, jQuery.extend(jQuery.easing, {
        ...
        easeInOutElastic: function (t, e, n, i, a) {
            ...
            return e < 1 ? -.5 * (s * Math.pow(2, 10 * (e -= 1)) * Math.sin((e * a - r) * (2 * Math.PI) / o)) + n : s * Math.pow(2, -10 * (e -= 1)) * Math.sin((e * a - r) * (2 * Math.PI) / o) * .5 + i + n
        },
        easeInBack: function (t, e, n, i, a, r) {
            return void 0 == r && (r = 1.70158), i * (e /= a) * e * ((r + 1) * e - r) + n
        },
        easeOutBack: function (t, e, n, i, a, r) {
            return void 0 == r && (r = 1.70158), i * ((e = e / a - 1) * e * ((r + 1) * e + r) + 1) + n
        },
        easeInOutBack: function (t, e, n, i, a, r) {
            return void 0 == r && (r = 1.70158), (e /= a / 2) < 1 ? i / 2 * (e * e * ((1 + (r *= 1.525)) * e - r)) + n : i / 2 * ((e -= 2) * e * ((1 + (r *= 1.525)) * e + r) + 2) + n
        },
            ...
            n.isWindow = function (t) {
                ...
                if (i) {
                    if (o)
                        ...
                        for (a in t)
                            if (n.apply(t[a], i) === !1) break
                } else if (o)
                    for (; r > a && n.call(t[a], a, t[a]) !== !1; a++);
                else
                    for (a in t)
                        if (n.call(t[a], a, t[a]) === !1) break;
                return t
                ...
                var t, e, i, a, r, o, s = arguments[0] || {},
                    ...
                    u = arguments.length,
                    d = !1;
                for ("boolean" == typeof s && (d = s, s = arguments[l] || {}, l++), "object" != typeof s && "function" !== n.type(s) && (s = {}), l === u && (s = this, l--); u > l; l++)
        ...
        return function (t, e, n, i) {
            ...
            function l(t, n, i, a) {
                ...
                function c() {
                    for (var e = 0; y > e; ++e) S[e] = l(e * x, t, i)
                }

                function h(e, n, a) {
                    var r, o, s = 0;
                    do {
                        o = n + (a - n) / 2, r = l(o, t, i) - e, r > 0 ? a = o : n = o
                    } while (Math.abs(r) > v && ++s < b);
                    return o
                }

                function f(e) {
                    for (var n = 0, a = 1, r = y - 1; a != r && S[a] <= e; ++a) n += x;
                    --a;
                    var o = (e - S[a]) / (S[a + 1] - S[a]),
                        s = n + o * x,
                        l = u(s, t, i);
                    return l >= m ? d(e, s) : 0 == l ? s : h(e, n, n + x)
                }
                ...
                var S = w ? new Float32Array(y) : new Array(y),
                    C = !1,
                    M = function (e) {
                        return C || p(), t === n && i === a ? e : 0 === e ? 0 : 1 === e ? 1 : l(f(e), n, a)
                    };
            ...
            function u(t, e) {
                var n = t;
                return g.isString(t) ? y.Easings[t] || (n = !1) : n = g.isArray(t) && 1 === t.length ? s.apply(null, t) : g.isArray(t) && 2 === t.length ? x.apply(null, t.concat([e])) : !(!g.isArray(t) || 4 !== t.length) && l.apply(null, t), n === !1 && (n = y.Easings[y.defaults.easing] ? y.defaults.easing : b), n
            }
            ...
            function d(t) {
                if (t) {
                    ...
                    n > 1e4 && (y.State.calls = a(y.State.calls));
                    for (var r = 0; n > r; r++)
                        if (y.State.calls[r]) {
                            var s = y.State.calls[r],
                                ...
                                p = !!f,
                                m = null;
                            f || (f = y.State.calls[r][3] = e - 16);
                            for (var v = Math.min((e - f) / u.duration, 1), b = 0, x = l.length; x > b; b++) {
                                var k = l[b],
                                    C = k.element;
                                if (o(C)) {
                                    var M = !1;
                                    ...
                                    u.visibility !== i && "hidden" !== u.visibility && w.setPropertyValue(C, "visibility", u.visibility);
                                    for (var A in k)
                                        if ("element" !== A) {
                                            var I, _ = k[A],
                                                T = g.isString(_.easing) ? y.Easings[_.easing] : _.easing;
                                            if (1 === v) I = _.endValue;
                                            else {
                                                var D = _.endValue - _.startValue;
                                                if (I = _.startValue + D * T(v, u, D), !p && I === _.currentValue) continue
                                            }
                                            if (_.currentValue = I, "tween" === A) m = I;
                                            else {
                                                if (w.Hooks.registered[A]) {
                                                    var V = w.Hooks.getRoot(A),
                                                        F = o(C).rootPropertyValueCache[V];
                                                    F && (_.rootPropertyValue = F)
                                                }
                                                var L = w.setPropertyValue(C, A, _.currentValue + (0 === parseFloat(I) ? "" : _.unitType), _.rootPropertyValue, _.scrollData);
                                                w.Hooks.registered[A] && (o(C).rootPropertyValueCache[V] = w.Normalizations.registered[V] ? w.Normalizations.registered[V]("extract", null, L[1]) : L[1]), "transform" === L[0] && (M = !0)
                                            }
                                        }
            ...
            function c(t, e) {
                ...
                for (var n = y.State.calls[t][0], a = y.State.calls[t][1], r = y.State.calls[t][2], s = y.State.calls[t][4], l = !1, u = 0, d = n.length; d > u; u++) {
                    var c = n[u].element;
                    if (e || r.loop || ("none" === r.display && w.setPropertyValue(c, "display", r.display), "hidden" === r.visibility && w.setPropertyValue(c, "visibility", r.visibility)), r.loop !== !0 && (h.queue(c)[1] === i || !/\.velocityQueueEntryFlag/i.test(h.queue(c)[1])) && o(c)) {
                        o(c).isAnimating = !1, o(c).rootPropertyValueCache = {};
                        var f = !1;
                        h.each(w.Lists.transforms3D, function (t, e) {
                            var n = /^scale/.test(e) ? 1 : 0,
                                a = o(c).transformCache[e];
                            o(c).transformCache[e] !== i && new RegExp("^\\(" + n + "[^.]").test(a) && (f = !0, delete o(c).transformCache[e])
                        }), r.mobileHA && (f = !0, delete o(c).transformCache.translate3d), f && w.flushTransformCache(c), w.Values.removeClass(c, "velocity-animating")
                    }
                    if (!e && r.complete && !r.loop && u === d - 1) try {
                        r.complete.call(a, a)
                    } catch (t) {
                        setTimeout(function () {
                            throw t
                    ...
                    s && r.loop !== !0 && s(a), o(c) && r.loop === !0 && !e && (h.each(o(c).tweensContainer, function (t, e) {
                        /^rotate/.test(t) && 360 === parseFloat(e.endValue) && (e.endValue = 0, e.startValue = 360), /^backgroundPosition/.test(t) && 100 === parseFloat(e.endValue) && "%" === e.unitType && (e.endValue = 0, e.startValue = 100)
                    }), y(c, "reverse", {
                        loop: !0,
                        delay: r.delay
                    })), r.queue !== !1 && h.dequeue(c, r.queue)
                }
                y.State.calls[t] = !1;
                for (var p = 0, g = y.State.calls.length; g > p; p++)
            ...
            var x = function () {
                ...
                return function t(e, i, a) {
                    var r, o, s, l = {
                        ...
                        u = [0],
                        d = 0;
                    for (e = parseFloat(e) || 500, i = parseFloat(i) || 20, a = a || null, l.tension = e, l.friction = i, r = null !== a, r ? (d = t(e, i), o = d / a * .016) : o = .016; s = n(s || l, o), u.push(1 + s.x), d += 16, Math.abs(s.x) > 1e-4 && Math.abs(s.v) > 1e-4;);
                    return r ? function (t) {
            ...
            var w = y.CSS = {
                ...
                Hooks: {
                    ...
                    register: function () {
                        ...
                        if (f)
                            for (n in w.Hooks.templates) {
                                i = w.Hooks.templates[n], a = i[0].split(" ");
                                var r = i[1].match(w.RegEx.valueSplit);
                                "Color" === a[0] && (a.push(a.shift()), r.push(r.shift()), w.Hooks.templates[n] = [a.join(" "), r.join(" ")])
                            }
                        for (n in w.Hooks.templates) {
                            i = w.Hooks.templates[n], a = i[0].split(" ");
                            for (var t in a) {
                    ...
                    extractValue: function (t, e) {
                        ...
                        if (n) {
                            var i = n[0],
                                a = n[1];
                            return e = w.Hooks.cleanRootPropertyValue(i, e), e.toString().match(w.RegEx.valueSplit)[a]
                        }
                        return e
                    },
                    injectValue: function (t, e, n) {
                        ...
                        if (i) {
                            var a, r = i[0],
                                o = i[1];
                            return n = w.Hooks.cleanRootPropertyValue(r, n), a = n.toString().match(w.RegEx.valueSplit), a[o] = e, a.join(" ")
                        }
                        return n
                    }
                },
                Normalizations: {
                    ...
                    register: function () {
                        ...
                        for (var t = 0; t < w.Lists.transformsBase.length; t++) ! function () {
                            ...
                            w.Normalizations.registered[e] = function (t, n, a) {
                                switch (t) {
                                    case "name":
                                        return "transform";
                                    case "extract":
                                    ...
                                    case "inject":
                                        ...
                                        switch (e.substr(0, e.length - 1)) {
                                            ...
                                            case "scal":
                                            case "scale":
                                                y.State.isAndroid && o(n).transformCache[e] === i && 1 > a && (a = 1), r = !/(\d)$/i.test(a);
                                                break;
                                            case "skew":
                                                r = !/(deg|\d)$/i.test(a);
                                                break;
                                ...
                                switch (t) {
                                    ...
                                    case "extract":
                                        ...
                                        if (w.RegEx.wrappedValueAlreadyExtracted.test(a)) r = a;
                                            ...
                                            /^[A-z]+$/i.test(a) ? o = s[a] !== i ? s[a] : s.black : w.RegEx.isHex.test(a) ? o = "rgb(" + w.Values.hexToRgb(a).join(" ") + ")" : /^rgba?\(/i.test(a) || (o = s.black), r = (o || a).toString().match(w.RegEx.valueUnwrap)[1].replace(/,(\s+)?/g, " ")
                                        }
                    ...
                    prefixCheck: function (t) {
                        ...
                        for (var e = ["", "Webkit", "Moz", "ms", "O"], n = 0, i = e.length; i > n; n++) {
                            ...
                            if (a = 0 === n ? t : e[n] + t.replace(/^\w/, function (t) {
                                ...
                                }), g.isString(y.State.prefixElement.style[a])) return y.State.prefixMatches[t] = a, [a, !0]
                        }
                        return [t, !1]
                    }
                },
                ...
                getPropertyValue: function (t, n, a, r) {
                    function s(t, n) {
                        function a() {
                        ...
                        if (8 >= f) l = h.css(t, n);
                            ...
                            var u = !1;
                            if (/^(width|height)$/.test(n) && 0 === w.getPropertyValue(t, "display") && (u = !0, w.setPropertyValue(t, "display", w.Values.getDisplayType(t))), !r) {
                            ...
                            var p;
                            p = o(t) === i ? e.getComputedStyle(t, null) : o(t).computedStyle ? o(t).computedStyle : o(t).computedStyle = e.getComputedStyle(t, null), "borderColor" === n && (n = "borderTopColor"), l = 9 === f && "filter" === n ? p.getPropertyValue(n) : p[n], ("" === l || null === l) && (l = t.style[n]), a()
                        }
                    ...
                    if (w.Hooks.registered[n]) {
                        var u = n,
                            d = w.Hooks.getRoot(u);
                        a === i && (a = w.getPropertyValue(t, w.Names.prefixCheck(d)[0])), w.Normalizations.registered[d] && (a = w.Normalizations.registered[d]("extract", t, a)), l = w.Hooks.extractValue(u, a)
                    } else if (w.Normalizations.registered[n]) {
                        var c, p;
                        c = w.Normalizations.registered[n]("name", t), "transform" !== c && (p = s(t, w.Names.prefixCheck(c)[0]), w.Values.isCSSNullValue(p) && w.Hooks.templates[n] && (p = w.Hooks.templates[n][1])), l = w.Normalizations.registered[n]("extract", t, p)
                    }
                    if (!/^[\d-]/.test(l))
                ...
                setPropertyValue: function (t, n, i, a, r) {
                    var s = n;
                    if ("scroll" === n) r.container ? r.container["scroll" + r.direction] = i : "Left" === r.direction ? e.scrollTo(i, r.alternateValue) : e.scrollTo(r.alternateValue, i);
                        ...
                        if (w.Hooks.registered[n]) {
                            var l = n,
                                u = w.Hooks.getRoot(n);
                            a = a || w.getPropertyValue(t, u), i = w.Hooks.injectValue(l, i, a), n = u
                        }
                        if (w.Normalizations.registered[n] && (i = w.Normalizations.registered[n]("inject", t, i), n = w.Normalizations.registered[n]("name", t)), s = w.Names.prefixCheck(n)[0], 8 >= f) try {
                            t.style[s] = i
                        } catch (t) {
                            y.debug && console.log("Browser does not support [" + i + "] for [" + s + "]")
                        } else o(t) && o(t).isSVG && w.Names.SVGAttribute(n) ? t.setAttribute(n, i) : t.style[s] = i;
                ...
                flushTransformCache: function (t) {
                    ...
                    if ((f || y.State.isAndroid && !y.State.isChrome) && o(t).isSVG) {
                        ...
                        h.each(o(t).transformCache, function (t) {
                            /^translate/i.test(t) ? t = "translate" : /^scale/i.test(t) ? t = "scale" : /^rotate/i.test(t) && (t = "rotate"), i[t] && (n += t + "(" + i[t].join(" ") + ") ", delete i[t])
                        })
                    } else {
                        var a, r;
                        h.each(o(t).transformCache, function (e) {
                            return a = o(t).transformCache[e], "transformPerspective" === e ? (r = a, !0) : (9 === f && "rotateZ" === e && (e = "rotate"), void(n += e + a + " "))
                        }), r && (n = "perspective" + r + " " + n)
                    }
            ...
            w.Hooks.register(), w.Normalizations.register(), y.hook = function (t, e, n) {
                ...
                return t = r(t), h.each(t, function (t, r) {
                    if (o(r) === i && y.init(r), n === i) a === i && (a = y.CSS.getPropertyValue(r, e));
                    else {
                        var s = y.CSS.setPropertyValue(r, e, n);
            ...
            var k = function () {
                ...
                function a() {
                    function t(t) {
                        function c(t, e) {
                            var n = i,
                                a = i,
                                o = i;
                            return g.isArray(t) ? (n = t[0], !g.isArray(t[1]) && /^[\d-]/.test(t[1]) || g.isFunction(t[1]) || w.RegEx.isHex.test(t[1]) ? o = t[1] : (g.isString(t[1]) && !w.RegEx.isHex.test(t[1]) || g.isArray(t[1])) && (a = e ? t[1] : u(t[1], s.duration), t[2] !== i && (o = t[2]))) : n = t, e || (a = a || s.easing), g.isFunction(n) && (n = n.call(r, C, S)), g.isFunction(o) && (o = o.call(r, C, S)), [n || 0, a, o]
                        }
                        ...
                        if ("scroll" === I) {
                            ...
                            s.container ? g.isWrapped(s.container) || g.isNode(s.container) ? (s.container = s.container[0] || s.container, v = s.container["scroll" + M], k = v + h(r).position()[M.toLowerCase()] + P) : s.container = null : (v = y.State.scrollAnchor[y.State["scrollProperty" + M]], x = y.State.scrollAnchor[y.State["scrollProperty" + ("Left" === M ? "Top" : "Left")]], k = h(r).offset()[M.toLowerCase()] + P), l = {
                                ...
                                element: r
                            }, y.debug && console.log("tweensContainer (scroll): ", l.scroll, r)
                        } else if ("reverse" === I) {
                            if (!o(r).tweensContainer) return void h.dequeue(r, s.queue);
                            "none" === o(r).opts.display && (o(r).opts.display = "auto"), "hidden" === o(r).opts.visibility && (o(r).opts.visibility = "visible"), o(r).opts.loop = !1, o(r).opts.begin = null, o(r).opts.complete = null, b.easing || delete s.easing, b.duration || delete s.duration, s = h.extend({}, o(r).opts, s);
                            var _ = h.extend(!0, {}, o(r).tweensContainer);
                            for (var T in _)
                                if ("element" !== T) {
                                    var D = _[T].startValue;
                                    _[T].startValue = _[T].currentValue = _[T].endValue, _[T].endValue = D, g.isEmptyObject(b) || (_[T].easing = s.easing), y.debug && console.log("reverse tweensContainer (" + T + "): " + JSON.stringify(_[T]), r)
                                }
                            l = _
                        } else if ("start" === I) {
                            var _;
                            o(r).tweensContainer && o(r).isAnimating === !0 && (_ = o(r).tweensContainer), h.each(m, function (t, e) {
                                if (RegExp("^" + w.Lists.colors.join("$|^") + "$").test(t)) {
                                    ...
                                    if (w.RegEx.isHex.test(a)) {
                                        for (var s = ["Red", "Green", "Blue"], l = w.Values.hexToRgb(a), u = o ? w.Values.hexToRgb(o) : i, d = 0; d < s.length; d++) {
                                            var h = [l[d]];
                            ...
                            for (var V in m) {
                                ...
                                if (o(r).isSVG || "tween" === B || w.Names.prefixCheck(B)[1] !== !1 || w.Normalizations.registered[B] !== i) {
                                    ...
                                    var N, H, j, q = !1;
                                    if (N = f(V, E), E = N[0], j = N[1], N = f(V, R), R = N[0].replace(/^([+-\/*])=/, function (t, e) {
                                            return q = e, ""
                                        }), H = N[1], E = parseFloat(E) || 0, R = parseFloat(R) || 0, "%" === H && (/^(fontSize|lineHeight)$/.test(V) ? (R /= 100, H = "em") : /^scale/.test(V) ? (R /= 100, H = "") : /(Red|Green|Blue)$/i.test(V) && (R = R / 100 * 255, H = "")), /[\/*]/.test(q)) H = j;
                                    else if (j !== H && 0 !== E)
                                        if (0 === R) H = j;
                                        else {
                                            a = a || function () {
                                                ...
                                                if (a && i) l.emToPx = L.lastEmToPx, l.percentToPxWidth = L.lastPercentToPxWidth, l.percentToPxHeight = L.lastPercentToPxHeight;
                                                    ...
                                                    var u = o(r).isSVG ? n.createElementNS("http://www.w3.org/2000/svg", "rect") : n.createElement("div");
                                                    y.init(u), t.myParent.appendChild(u), h.each(["overflow", "overflowX", "overflowY"], function (t, e) {
                                                        y.CSS.setPropertyValue(u, e, "hidden")
                                                    }), y.CSS.setPropertyValue(u, "position", t.position), y.CSS.setPropertyValue(u, "fontSize", t.fontSize), y.CSS.setPropertyValue(u, "boxSizing", "content-box"), h.each(["minWidth", "maxWidth", "width", "minHeight", "maxHeight", "height"], function (t, e) {
                                                        y.CSS.setPropertyValue(u, e, s + "%")
                                                    }), y.CSS.setPropertyValue(u, "paddingLeft", s + "em"), l.percentToPxWidth = L.lastPercentToPxWidth = (parseFloat(w.getPropertyValue(u, "width", null, !0)) || 1) / s, l.percentToPxHeight = L.lastPercentToPxHeight = (parseFloat(w.getPropertyValue(u, "height", null, !0)) || 1) / s, l.emToPx = L.lastEmToPx = (parseFloat(w.getPropertyValue(u, "paddingLeft")) || 1) / s, t.myParent.removeChild(u)
                                                }
                                                return null === L.remToPx && (L.remToPx = parseFloat(w.getPropertyValue(n.body, "fontSize")) || 16), null === L.vwToPx && (L.vwToPx = parseFloat(e.innerWidth) / 100, L.vhToPx = parseFloat(e.innerHeight) / 100), l.remToPx = L.remToPx, l.vwToPx = L.vwToPx, l.vhToPx = L.vhToPx, y.debug >= 1 && console.log("Unit ratios: " + JSON.stringify(l), r), l
                                            }();
                                            var Y = /margin|padding|left|right|width|text|word|letter/i.test(V) || /X$/.test(V) || "x" === V ? "x" : "y";
                                            switch (j) {
                                                case "%":
                                                    E *= "x" === Y ? a.percentToPxWidth : a.percentToPxHeight;
                                                    break;
                                                case "px":
                                                    break;
                                                default:
                                    ...
                                    l[V] = {
                                        ...
                                        unitType: H,
                                        easing: W
                                    }, y.debug && console.log("tweensContainer (" + V + "): " + JSON.stringify(l[V]), r)
                                } else y.debug && console.log("Skipping [" + B + "] due to a lack of browser support.")
                            }
                            l.element = r
                        }
                        l.element && (w.Values.addClass(r, "velocity-animating"), O.push(l), "" === s.queue && (o(r).tweensContainer = l, o(r).opts = s), o(r).isAnimating = !0, C === S - 1 ? (y.State.calls.push([O, p, s, null, A.resolver]), y.State.isTicking === !1 && (y.State.isTicking = !0, d())) : C++)
                    }
                    var a, r = this,
                        s = h.extend({}, y.defaults, b),
                        l = {};
                    switch (o(r) === i && y.init(r), parseFloat(s.delay) && s.queue !== !1 && h.queue(r, s.queue, function (t) {
                        y.velocityQueueEntryFlag = !0, o(r).delayTimer = {
                    ...
                    y.mock !== !1 && (y.mock === !0 ? s.duration = s.delay = 1 : (s.duration *= parseFloat(y.mock) || 1, s.delay *= parseFloat(y.mock) || 1)), s.easing = u(s.easing, s.duration), s.begin && !g.isFunction(s.begin) && (s.begin = null), s.progress && !g.isFunction(s.progress) && (s.progress = null), s.complete && !g.isFunction(s.complete) && (s.complete = null), s.display !== i && null !== s.display && (s.display = s.display.toString().toLowerCase(), "auto" === s.display && (s.display = y.CSS.Values.getDisplayType(r))), s.visibility !== i && null !== s.visibility && (s.visibility = s.visibility.toString().toLowerCase()), s.mobileHA = s.mobileHA && y.State.isMobile && !y.State.isGingerbread, s.queue === !1 ? s.delay ? setTimeout(t, s.delay) : t() : h.queue(r, s.queue, function (e, n) {
                        return n === !0 ? (A.promise && A.resolver(p), !0) : (y.velocityQueueEntryFlag = !0, void t(e))
                ...
                if (g.isWrapped(this) ? (s = !1, f = 0, p = this, l = this) : (s = !0, f = 1, p = x ? arguments[0].elements || arguments[0].e : arguments[0]), p = r(p)) {
                    x ? (m = arguments[0].properties || arguments[0].p, b = arguments[0].options || arguments[0].o) : (m = arguments[f], b = arguments[f + 1]);
                    var S = p.length,
                        C = 0;
                    if (!/^(stop|finish)$/i.test(m) && !h.isPlainObject(b)) {
                        var M = f + 1;
                        b = {};
                        for (var P = M; P < arguments.length; P++) g.isArray(arguments[P]) || !/^(fast|normal|slow)$/i.test(arguments[P]) && !/^\d/.test(arguments[P]) ? g.isString(arguments[P]) || g.isArray(arguments[P]) ? b.easing = arguments[P] : g.isFunction(arguments[P]) && (b.complete = arguments[P]) : b.duration = arguments[P]
                    }
                    var A = {
                        promise: null,
                        resolver: null,
                    ...
                    s && y.Promise && (A.promise = new y.Promise(function (t, e) {
                    ...
                    switch (m) {
                        ...
                        case "stop":
                            ...
                            var _ = [];
                            return h.each(y.State.calls, function (t, e) {
                                e && h.each(e[1], function (n, a) {
                                    var r = b === i ? "" : b;
                                    return r !== !0 && e[2].queue !== r && (b !== i || e[2].queue !== !1) || void h.each(p, function (n, i) {
                                        i === a && ((b === !0 || g.isString(b)) && (h.each(h.queue(i, g.isString(b) ? b : ""), function (t, e) {
                                            g.isFunction(e) && e(null, !0)
                                        }), h.queue(i, g.isString(b) ? b : "", [])), "stop" === m ? (o(i) && o(i).tweensContainer && r !== !1 && h.each(o(i).tweensContainer, function (t, e) {
                                            e.endValue = e.currentValue
                                        }), _.push(t)) : "finish" === m && (e[2].duration = 1))
                                    })
                                })
                            }), "stop" === m && (h.each(_, function (t, e) {
                                c(e, !0)
                            }), A.promise && A.resolver(p)), t();
                        default:
                            if (!h.isPlainObject(m) || g.isEmptyObject(m)) {
                                if (g.isString(m) && y.Redirects[m]) {
                                    var T = h.extend({}, b),
                                        D = T.duration,
                                        V = T.delay || 0;
                                    return T.backwards === !0 && (p = h.extend(!0, [], p).reverse()), h.each(p, function (t, e) {
                                        parseFloat(T.stagger) ? T.delay = V + parseFloat(T.stagger) * t : g.isFunction(T.stagger) && (T.delay = V + T.stagger.call(e, t, S)), T.drag && (T.duration = parseFloat(D) || (/^(callout|transition)/.test(m) ? 1e3 : v), T.duration = Math.max(T.duration * (T.backwards ? 1 - t / S : (t + 1) / S), .75 * T.duration, 200)), y.Redirects[m].call(e, e, T || {}, t, S, p, A.promise ? A : i)
                                    }), t()
                                }
                    ...
                    var R, T = h.extend({}, y.defaults, b);
                    if (T.loop = parseInt(T.loop), R = 2 * T.loop - 1, T.loop)
                        for (var W = 0; R > W; W++) {
                            var E = {
                                delay: T.delay,
                                progress: T.progress
                            };
                            W === R - 1 && (E.display = T.display, E.visibility = T.visibility, E.complete = T.complete), k(p, "reverse", E)
                        }
                    return t()
                }
            };
            ...
            return y.State.isMobile || n.hidden === i || n.addEventListener("visibilitychange", function () {
            ...
            }), t.Velocity = y, t !== e && (t.fn.velocity = k, t.fn.velocity.defaults = y.defaults), h.each(["Down", "Up"], function (t, e) {
                y.Redirects["slide" + e] = function (t, n, a, r, o, s) {
                    var l = h.extend({}, n),
                        u = l.begin,
                        d = l.complete,
                        c = {
                ...
                y.Redirects["fade" + e] = function (t, n, a, r, o, s) {
                    var l = h.extend({}, n),
                        u = {
                            opacity: "In" === e ? 1 : 0
                        },
                    ...
                    l.complete = a !== r - 1 ? l.begin = null : function () {
                        d && d.call(o, o), s && s.resolver(o)
                    }, l.display === i && (l.display = "In" === e ? "auto" : "none"), y(this, u, l)
                }
            }), y
    ...
    function (t) {
        ...
        return function t(e, n, i) {
                ...
                function i(t) {
                    if (t) {
                        ...
                        if (i) {
                            ...
                            i = i[1];
                            for (var a = 0; a < e.length; a++) e[a] = parseInt(i.slice(2 * a, 2 * a + 2), 16)
                        } else if (i = t.match(/^rgba?\(\s*([+-]?\d+)\s*,\s*([+-]?\d+)\s*,\s*([+-]?\d+)\s*(?:,\s*([+-]?[\d\.]+)\s*)?\)$/)) {
                            for (var a = 0; a < e.length; a++) e[a] = parseInt(i[a + 1]);
                            n = parseFloat(i[4])
                        } else if (i = t.match(/^rgba?\(\s*([+-]?[\d\.]+)\%\s*,\s*([+-]?[\d\.]+)\%\s*,\s*([+-]?[\d\.]+)\%\s*(?:,\s*([+-]?[\d\.]+)\s*)?\)$/)) {
                            for (var a = 0; a < e.length; a++) e[a] = Math.round(2.55 * parseFloat(i[a + 1]));
                            n = parseFloat(i[4])
                        } else if (i = t.match(/(\w+)/)) {
                            if ("transparent" == i[1]) return [0, 0, 0, 0];
                            if (!(e = x[i[1]])) return
                        }
                        for (var a = 0; a < e.length; a++) e[a] = b(e[a], 0, 255);
                        return n = n || 0 == n ? b(n, 0, 1) : 1, e[3] = n, e
                    }
                }
                ...
                function a(t) {
                    if (t) {
                        ...
                        if (e) {
                            ...
                            return [b(parseInt(e[1]), 0, 360), b(parseFloat(e[2]), 0, 100), b(parseFloat(e[3]), 0, 100), b(isNaN(n) ? 1 : n, 0, 1)]
                        }
                    }
                }
            ...
            4: [function (t, e, n) {
                ...
                function W(t) {
                    var e, n, i, a, r = t[0],
                        o = t[1],
                        s = t[2];
                    return r <= 8 ? (n = 100 * r / 903.3, a = n / 100 * 7.787 + 16 / 116) : (n = 100 * Math.pow((r + 16) / 116, 3), a = Math.pow(n / 100, 1 / 3)), e = e / 95.047 <= .008856 ? e = 95.047 * (o / 500 + a - 16 / 116) / 7.787 : 95.047 * Math.pow(o / 500 + a, 3), i = i / 108.883 <= .008859 ? i = 108.883 * (a - s / 200 - 16 / 116) / 7.787 : 108.883 * Math.pow(a - s / 200, 3), [e, n, i]
                }
                ...
                var $ = {
                    ...
                    Z = {};
                for (var K in $) Z[JSON.stringify($[K])] = K
            }, {}],
            5: [function (t, e, n) {
                var i = t(4),
                    a = function () {
                    ...
                    t.defaults.bar = {
                        ...
                        getStackCount: function (t) {
                            var e, n, i = this,
                                ...
                                l = [];
                            for (e = 0; e < s; ++e) n = a.getDatasetMeta(e), n.bar && a.isDatasetVisible(e) && (o === !1 || o === !0 && l.indexOf(n.stack) === -1 || void 0 === o && (void 0 === n.stack || l.indexOf(n.stack) === -1)) && l.push(n.stack);
                            return l.length
                        },
                        ...
                        calculateBarValuePixels: function (t, e) {
                            ...
                            if (p || void 0 === p && void 0 !== g)
                                for (n = 0; n < t; ++n) i = u.getDatasetMeta(n), i.bar && i.stack === g && i.controller.getValueScaleId() === c.id && u.isDatasetVisible(n) && (a = Number(h[n].data[e]), (f < 0 && a < 0 || f >= 0 && a > 0) && (m += a));
                        ...
                        draw: function () {
                            var t, n = this,
                                ...
                                o = a.length,
                                s = 0;
                            for (e.canvas.clipArea(i.ctx, i.chartArea); s < o; ++s) null === (t = r.data[s]) || void 0 === t || isNaN(t) || a[s].draw();
                ...
                e.exports = function (t) {
                    ...
                    t.defaults.bubble = {
                        ...
                        updateElement: function (n, i, a) {
                            ...
                            var p = n._model;
                            p.skip = u.skip ? u.skip : isNaN(p.x) || isNaN(p.y), n.pivot()
                        },
                        ...
                        setHoverStyle: function (n) {
                            ...
                            var a = i.chart.data.datasets[n._datasetIndex],
                                r = n._index,
                                o = n.custom || {};
                            n._model.radius = o.hoverRadius ? o.hoverRadius : e.getValueAtIndexOrDefault(a.hoverRadius, r, i.chart.options.elements.point.hoverRadius) + i.getRadius(a.data[r])
                        },
                ...
                e.exports = function (t) {
                    ...
                    n.doughnut = {
                        ...
                        updateElement: function (t, n, i) {
                            ...
                            var b = t._model;
                            this.removeHoverStyle(t), i && l.animateRotate || (b.startAngle = 0 === n ? s.rotation : a.getMeta().data[n - 1]._model.endAngle, b.endAngle = b.startAngle + b.circumference), t.pivot()
                        },
                        removeHoverStyle: function (e) {
                ...
                e.exports = function (t) {
                    ...
                    t.defaults.line = {
                        ...
                        update: function (t) {
                            ...
                            for (p && 0 !== l._model.tension && o.updateBezierControlPoints(), i = 0, a = u.length; i < a; ++i) u[i].pivot()
                        },
                        ...
                        updateElement: function (t, e, i) {
                            ...
                            void 0 !== u.radius && void 0 === u.pointRadius && (u.pointRadius = u.radius), void 0 !== u.hitRadius && void 0 === u.pointHitRadius && (u.pointHitRadius = u.hitRadius), a = f.getPixelForValue("object" == typeof c ? c : NaN, e, d, m), r = i ? h.getBasePixel() : o.calculatePointY(c, e, d), t._xScale = f, t._yScale = h, t._datasetIndex = d, t._index = e, t._model = {
                                x: a,
                                y: r,
                                skip: l.skip || isNaN(a) || isNaN(r),
                                radius: l.radius || n.getValueAtIndexOrDefault(u.pointRadius, e, p.radius),
                                pointStyle: l.pointStyle || n.getValueAtIndexOrDefault(u.pointStyle, e, p.pointStyle),
                                ...
                                hitRadius: l.hitRadius || n.getValueAtIndexOrDefault(u.pointHitRadius, e, p.hitRadius)
                            }
                        },
                        ...
                        draw: function () {
                            var n = this,
                                ...
                                s = r.length,
                                l = 0;
                            for (t.canvasHelpers.clipArea(i.ctx, o), e(n.getDataset(), i.options) && a.dataset.draw(), t.canvasHelpers.unclipArea(i.ctx); l < s; ++l) r[l].draw(o)
                        },
                        setHoverStyle: function (t) {
            ...
            19: [function (t, e, n) {
                ...
                e.exports = function (t) {
                    ...
                    t.defaults.polarArea = {
                        ...
                        updateElement: function (t, n, i) {
                            for (var a = this, r = a.chart, o = a.getDataset(), s = r.options, l = s.animation, u = r.scale, d = e.getValueAtIndexOrDefault, c = r.data.labels, h = a.calculateCircumference(o.data[n]), f = u.xCenter, p = u.yCenter, g = 0, m = a.getMeta(), v = 0; v < n; ++v) isNaN(o.data[v]) || m.data[v].hidden || ++g;
                            var b = s.startAngle,
                            ...
                            e.extend(t, {
                                ...
                                _model: {
                                    ...
                                    endAngle: i && l.animateRotate ? b : w,
                                    label: d(c, n, c[n])
                                }
            ...
            21: [function (t, e, n) {
                ...
                e.exports = function (t) {
                    ...
                    t.defaults.global.animation = {
                        ...
                        advance: function (t) {
                            for (var n, i, a = this.animations, r = 0; r < a.length;) n = a[r], i = n.chart, n.currentStep = (n.currentStep || 0) + t, n.currentStep = Math.min(n.currentStep, n.numSteps), e.callback(n.render, [i, n], i), e.callback(n.onAnimationProgress, [n], i), n.currentStep >= n.numSteps ? (e.callback(n.onAnimationComplete, [n], i), i.animating = !1, a.splice(r, 1)) : ++r
                        }
            ...
            22: [function (t, e, n) {
                ...
                e.exports = function (t) {
                    ...
                    e.drawPoint = function (e, n, i, a, r) {
                        var o, s, l, u, d, c;
                        if ("object" == typeof n && ("[object HTMLImageElement]" === (o = n.toString()) || "[object HTMLCanvasElement]" === o)) return void e.drawImage(n, a - n.width / 2, r - n.height / 2, n.width, n.height);
                        if (!(isNaN(i) || i <= 0)) {
                            switch (n) {
                                default: e.beginPath(),
                                ...
                                case "rectRounded":
                                        ...
                                        f = a - h,
                                        p = r - h,
                                        g = Math.SQRT2 * i;t.helpers.drawRoundedRectangle(e, f, p, g, g, i / 2),
                                    e.fill();
                                    break;
                                case "rectRot":
                                        c = 1 / Math.SQRT2 * i,
                    ...
                    t.types = {}, t.instances = {}, t.controllers = {}, a.extend(t.prototype, {
                        construct: function (n, i) {
                            ...
                            var s = o.acquireContext(n, i),
                                ...
                                u = l && l.height,
                                d = l && l.width;
                            if (r.id = a.uid(), r.ctx = s, r.canvas = l, r.config = i, r.width = d, r.height = u, r.aspectRatio = u ? d / u : null, r.options = i.options, r._bufferedRender = !1, r.chart = r, r.controller = r, t.instances[r.id] = r, Object.defineProperty(r, "data", {
                                    get: function () {
                        ...
                        destroy: function () {
                            var e, n, i, s = this,
                                l = s.canvas;
                            for (s.stop(), n = 0, i = s.data.datasets.length; n < i; ++n) e = s.getDatasetMeta(n), e.controller && (e.controller.destroy(), e.controller = null);
            ...
            25: [function (t, e, n) {
                ...
                e.exports = function (t) {
                    function e(t, e, n, a) {
                        var r, o, s, l, u, d, c, h, f, p = Object.keys(n);
                        for (r = 0, o = p.length; r < o; ++r)
                            if (s = p[r], d = n[s], e.hasOwnProperty(s) || (e[s] = d), (l = e[s]) !== d && "_" !== s[0]) {
                ...
                e.exports = function (t) {
                    ...
                    r.each = function (t, e, n, i) {
                        ...
                        return r.each(t, function (t, n) {
                            r.isArray(t) ? e[n] = t.slice(0) : e[n] = "object" == typeof t && null !== t ? r.clone(t) : t
                        }), e
                    }, r.extend = function (t) {
                    ...
                    r.requestAnimFrame = function () {
                        ...
                        return n = Math.round((n - s.left - u) / f * o.width / e.currentDevicePixelRatio), i = Math.round((i - s.top - d) / p * o.height / e.currentDevicePixelRatio), {
                            x: n,
                            y: i
                        }
                    ...
                    t.layoutService = {
                        ...
                        update: function (t, a, r) {
                            function o(t) {
                                ...
                                n ? (e = t.update(t.fullWidth ? w : A, P), I -= e.height) : (e = t.update(M, C), A -= e.width), _.push({
                                    horizontal: n,
                                    minSize: e,
                                    box: t
                                })
                            ...
                            function s(t) {
                                ...
                                if (e)
                                    ...
                                    } else t.update(e.minSize.width, I)
                            }
                            ...
                            function l(t) {
                                ...
                                e && t.update(e.minSize.width, I, n)
                            }

                            function u(t) {
                                t.isHorizontal() ? (t.left = t.fullWidth ? h : L, t.right = t.fullWidth ? a - f : L + A, t.top = j, t.bottom = j + t.height, j = t.bottom) : (t.left = H, t.right = H + t.width, t.top = R, t.bottom = R + I, H = t.right)
                            }
                            if (t) {
                                var d = t.options.layout,
                                    ...
                                    p = 0,
                                    g = 0;
                                isNaN(c) ? (h = c.left || 0, f = c.right || 0, p = c.top || 0, g = c.bottom || 0) : (h = c, f = c, p = c, g = c);
                                var m = e(t.boxes, "left"),
                                    v = e(t.boxes, "right"),
                                    b = e(t.boxes, "top"),
                                    y = e(t.boxes, "bottom"),
                                    x = e(t.boxes, "chartArea");
                                n(m, !0), n(v, !1), n(b, !0), n(y, !1);
                                var w = a - h - f,
                                    k = r - p - g,
                                    S = w / 2,
                                    C = k / 2,
                                    ...
                                    I = k,
                                    _ = [];
                                i.each(m.concat(v, b, y), o);
                                var T = 0,
                                    D = 0,
                                    V = 0,
                                    F = 0;
                                i.each(b.concat(y), function (t) {
                                    if (t.getPadding) {
                                        var e = t.getPadding();
                                        T = Math.max(T, e.left), D = Math.max(D, e.right)
                                    }
                                }), i.each(m.concat(v), function (t) {
                                    if (t.getPadding) {
                                        var e = t.getPadding();
                                        V = Math.max(V, e.top), F = Math.max(F, e.bottom)
                                    }
                                });
                                var L = h,
                                    O = f,
                                ...
                                i.each(m.concat(v), s), i.each(m, function (t) {
                                    ...
                                    O += t.width
                                }), i.each(b.concat(y), s), i.each(b, function (t) {
                                    R += t.height
                                }), i.each(y, function (t) {
                                    W += t.height
                                }), i.each(m.concat(v), l), L = h, O = f, R = p, W = g, i.each(m, function (t) {
                                    L += t.width
                                }), i.each(v, function (t) {
                                    O += t.width
                                }), i.each(b, function (t) {
                                ...
                                var E = Math.max(T - L, 0);
                                L += E, O += Math.max(D - O, 0);
                                var B = Math.max(V - R, 0);
                                R += B, W += Math.max(F - W, 0);
                                var z = r - R - W,
                                    N = a - L - O;
                                N === A && z === I || (i.each(m, function (t) {
                                    t.height = z
                                }), i.each(v, function (t) {
                                    t.height = z
                                }), i.each(b, function (t) {
                                ...
                                var H = h + E,
                                    j = p + B;
                                i.each(m.concat(b), u), H += A, j += I, i.each(v, u), i.each(y, u), t.chartArea = {
                                    left: L,
                                    top: R,
                                    right: L + A,
                                    bottom: R + I
                                }, i.each(x, function (e) {
                                    e.left = t.chartArea.left, e.top = t.chartArea.top, e.right = t.chartArea.right, e.bottom = t.chartArea.bottom, e.update(A, I)
                                })
                            }
                        }
                    }
                        ...
                        descriptors: function (n) {
                            ...
                            return this._plugins.concat(o.plugins || []).forEach(function (t) {
                                if (a.indexOf(t) === -1) {
                                    var n = t.id,
                                        i = l[n];
                                    i !== !1 && (i === !0 && (i = e.clone(s[n])), a.push(t), r.push({
                                        plugin: t,
                                        options: i || {}
                                    }))
                                }
                    ...
                    t.defaults.scale = {
                        ...
                        calculateTickRotation: function () {
                            ...
                            if (t.options.display && t.isHorizontal())
                                for (var s, l = i.longestText(e, r.font, t.ticks, t.longestTextCache), u = l, d = t.getPixelForTick(1) - t.getPixelForTick(0) - 6; u > d && o < a.maxRotation;) {
                                    var c = i.toRadians(o);
                        ...
                        fit: function () {
                            ...
                            if (a.width = d ? t.isFullWidth() ? t.maxWidth - t.margins.left - t.margins.right : t.maxWidth : u && l.drawTicks ? f : 0, a.height = d ? u && l.drawTicks ? f : 0 : t.maxHeight, s.display && u && (d ? a.height += h : a.width += h), o.display && u) {
                                var p = i.longestText(t.ctx, c.font, t.ticks, t.longestTextCache),
                                ...
                                if (d) {
                                    ...
                                    var w = t.ticks[0],
                                        ...
                                        C = e(t.ctx, S, c.font);
                                    0 !== t.labelRotation ? (t.paddingLeft = "bottom" === r.position ? b * k + 3 : b * m + 3, t.paddingRight = "bottom" === r.position ? b * m + 3 : b * C + 3) : (t.paddingLeft = k / 2 + 3, t.paddingRight = C / 2 + 3)
                                ...
                                if (i.each(a.ticks, function (t, n) {
                                        if (void 0 !== t && null !== t) {
                                            ...
                                            if ((!(o > 1 && n % o > 0 || n % o == 0 && n + o >= a.ticks.length) || s) && void 0 !== t && null !== t) {
                                                ...
                                                var v, y, x, k, S, _, T, D, V, F, L = "middle",
                                                    O = "middle";
                                                if (g) {
                                                    "bottom" === r.position ? (O = f ? "middle" : "top", L = f ? "right" : "center", F = a.top + b) : (O = f ? "middle" : "bottom", L = f ? "left" : "center", F = a.bottom - b);
                                                    var R = a.getPixelForTick(n) + i.aliasPixel(l);
                                                    V = a.getPixelForTick(n, c.offsetGridLines) + d.labelOffset, v = x = S = T = R, y = A, k = I, _ = e.top, D = e.bottom
                                                } else {
                                                    var W, E = "left" === r.position,
                                                        B = d.padding;
                                                    d.mirror ? (L = E ? "left" : "right", W = B) : (L = E ? "right" : "left", W = b + B), V = E ? a.right - W : a.left + W;
                                                    var z = a.getPixelForTick(n);
                                                    z += i.aliasPixel(l), F = a.getPixelForTick(n, c.offsetGridLines), v = M, x = P, S = e.left, T = e.right, y = k = _ = D = z
                                                }
                                                C.push({
                                                    tx1: v,
                                                    ty1: y,
                                    ...
                                    var _, T, D = 0;
                                    if (g) _ = a.left + (a.right - a.left) / 2, T = "bottom" === r.position ? a.bottom - x.size / 2 : a.top + x.size / 2;
                                    else {
                                        var V = "left" === r.position;
                                        _ = V ? a.left + x.size / 2 : a.right - x.size / 2, T = a.top + (a.bottom - a.top) / 2, D = V ? -.5 * Math.PI : .5 * Math.PI
                                    }
                                    l.save(), l.translate(_, T), l.rotate(D), l.textAlign = "center", l.textBaseline = "middle", l.fillStyle = y, l.font = x.font, l.fillText(h.labelString, 0, 0), l.restore()
                                }
                                if (c.drawBorder) {
                                    ...
                                    g ? (O = R = "top" === r.position ? a.bottom : a.top, O += W, R += W) : (F = L = "left" === r.position ? a.right : a.left, F += W, L += W), l.beginPath(), l.moveTo(F, O), l.lineTo(L, R), l.stroke()
                                }
                            }
                        }
                    })
            ...
            34: [function (t, e, n) {
                ...
                e.exports = function (t) {
                    ...
                    function r(t, e) {
                        ...
                        return n.font = l.fontString(d, e._titleFontStyle, e._titleFontFamily), l.each(e.title, p), n.font = l.fontString(c, e._bodyFontStyle, e._bodyFontFamily), l.each(e.beforeBody.concat(e.afterBody), p), f = e.displayColors ? c + 2 : 0, l.each(r, function (t) {
                            l.each(t.before, p), l.each(t.lines, p), l.each(t.after, p)
                        }), f = 0, n.font = l.fontString(h, e._footerFontStyle, e._footerFontFamily), l.each(e.footer, p), a += 2 * e.xPadding, {
                            width: a,
                            height: i
                        }
                    }
                    ...
                    t.defaults.global.tooltips = {
                        ...
                        update: function (e) {
                            ...
                            if (p.length) {
                                f.opacity = 1;
                                var x = [];
                                y = t.Tooltip.positioners[c.position](p, d._eventPosition);
                                var w = [];
                                for (n = 0, u = p.length; n < u; ++n) w.push(i(p[n]));
                                c.filter && (w = w.filter(function (t) {
                                    return c.filter(t, g)
                                })), c.itemSort && (w = w.sort(function (t, e) {
                                    return c.itemSort(t, e, g)
                                })), l.each(w, function (t) {
                                    x.push(c.callbacks.labelColor.call(d, t, d._chart))
                                }), f.title = d.getTitle(w, g), f.beforeBody = d.getBeforeBody(w, g), f.body = d.getBody(w, g), f.afterBody = d.getAfterBody(w, g), f.footer = d.getFooter(w, g), f.x = Math.round(y.x), f.y = Math.round(y.y), f.caretPadding = c.caretPadding, f.labelColors = x, f.dataPoints = w, b = r(this, f), m = o(this, b), v = s(f, b, m)
                            } else f.opacity = 0;
                            return f.xAlign = m.xAlign, f.yAlign = m.yAlign, f.x = v.x, f.y = v.y, f.width = b.width, f.height = b.height, f.caretX = y.x, f.caretY = y.y, d._model = f, e && c.custom && c.custom.call(d, f), d
                        },
                        ...
                        getCaretPosition: function (t, e, n) {
                            var i, a, r, o, s, l, u = n.caretSize,
                                ...
                                g = e.width,
                                m = e.height;
                            if ("center" === h) s = p + m / 2, "left" === c ? (i = f, a = i - u, r = i, o = s + u, l = s - u) : (i = f + g, a = i + u, r = i, o = s - u, l = s + u);
                        ...
                        handleEvent: function (t) {
                            var e = this,
                                n = e._options,
                                i = !1;
                            if (e._lastActive = e._lastActive || [], "mouseout" === t.type ? e._active = [] : e._active = e._chart.getElementsAtEventForMode(t, n.mode, n), !(i = !l.arrayEquals(e._active, e._lastActive))) return !1;
                ...
                e.exports = function (t) {
                    ...
                    i.elements.rectangle = {
                        ...
                        inLabelRange: function (t, i) {
                            ...
                            if (!a._view) return !1;
                            var r = n(a);
                            return e(a) ? t >= r.left && t <= r.right : i >= r.top && i <= r.bottom
                        },
                        inXRange: function (t) {
                            var e = n(this);
            ...
            41: [function (t, e, n) {
                ...
                e.exports = function (t) {
                    ...
                    function o(t, e, n, i, a) {
                        var r;
                        if (i && a) {
                            for (t.moveTo(e[0].x, e[0].y), r = 1; r < i; ++r) u.canvas.lineTo(t, e[r - 1], e[r]);
                            for (t.lineTo(n[a - 1].x, n[a - 1].y), r = a - 1; r > 0; --r) u.canvas.lineTo(t, n[r], n[r - 1], !0)
                        }
                    }

                    function s(t, e, n, i, a, s) {
                        var l, u, d, c, h, f, p, g = e.length,
                            m = i.spanGaps,
                            v = [],
                            b = [],
                            y = 0,
                            x = 0;
                        for (t.beginPath(), l = 0, u = g + !!s; l < u; ++l) d = l % g, c = e[d]._view, h = n(c, d, i), f = r(c), p = r(h), f && p ? (y = v.push(c), x = b.push(h)) : y && x && (m ? (f && v.push(c), p && b.push(h)) : (o(t, v, b, y, x), y = x = 0, v = [], b = []));
                    ...
                    return {
                        ...
                        afterDatasetsUpdate: function (r, o) {
                            var s, l, u, d, c = (r.data.datasets || []).length,
                                h = o.propagate,
                                f = [];
                            for (l = 0; l < c; ++l) s = r.getDatasetMeta(l), u = s.dataset, d = null, u && u._model && u instanceof t.elements.Line && (d = {
                                visible: r.isDatasetVisible(l),
                                fill: e(u, l, c),
                                chart: r,
                                el: u
                            }), s.$filler = d, f.push(d);
                            for (l = 0; l < c; ++l)(d = f[l]) && (d.fill = i(f, l, h), d.boundary = n(d), d.mapper = a(d))
                        },
                            ...
                            if (m ? (g.width = n.maxWidth, g.height = o ? 10 : 0) : (g.width = o ? 10 : 0, g.height = n.maxHeight), o)
                                if (s.font = f, m) {
                                    ...
                                    s.textAlign = "left", s.textBaseline = "top", i.each(n.legendItems, function (t, i) {
                                        ...
                                        v[v.length - 1] + o + r.padding >= n.width && (b += d + r.padding, v[v.length] = n.left), p[i] = {
                                            left: 0,
                                            top: 0,
                                            width: o,
                                            height: d
                                    ...
                                    i.each(n.legendItems, function (t, n) {
                                        ...
                                        S + C > g.height && (w += k + r.padding, x.push(k), k = 0, S = 0), k = Math.max(k, a), S += C, p[n] = {
                                            left: 0,
                                            top: 0,
                                            width: a,
                                            height: d
                            ...
                            if (a.display) {
                                ...
                                var b = e(r, p),
                                    ...
                                    x = function (e, n, i) {
                                        if (!(isNaN(b) || b <= 0)) {
                                            ...
                                            } else r || c.strokeRect(e, n, b, p), c.fillRect(e, n, b, p);
                                            c.restore()
                                        }
                                    },
                                    w = function (t, e, n, i) {
                                        c.fillText(n.text, b + p / 2 + t, e), n.hidden && (c.beginPath(), c.lineWidth = 2, c.moveTo(b + p / 2 + t, e + p / 2), c.lineTo(b + p / 2 + t + i, e + p / 2), c.stroke())
                                    },
                                    k = n.isHorizontal();
                                d = k ? {
                                    x: n.left + (l - u[0]) / 2,
                                ...
                                i.each(n.legendItems, function (t, e) {
                                    var i = c.measureText(t.text).width,
                                        ...
                                        o = d.x,
                                        s = d.y;
                                    k ? o + a >= l && (s = d.y += S, d.line++, o = d.x = n.left + (l - u[d.line]) / 2) : s + S > n.bottom && (o = d.x = o + n.columnWidths[d.line] + r.padding, s = d.y = n.top + r.padding, d.line++), x(o, s, t), y[e].left = o, y[e].top = s, w(o, s, t, i), k ? d.x += a + r.padding : d.y += S
                                })
                            }
                        },
                        handleEvent: function (t) {
                        ...
                        draw: function () {
                            ...
                            if (r.display) {
                                var s, l, u, d = a(r.fontSize, o.defaultFontSize),
                                    ...
                                    v = e.bottom,
                                    b = e.right;
                                i.fillStyle = a(r.fontColor, o.defaultFontColor), i.font = f, e.isHorizontal() ? (s = m + (b - m) / 2, l = g + (v - g) / 2, u = b - m) : (s = "left" === r.position ? m + d / 2 : b - d / 2, l = g + (v - g) / 2, u = v - g, p = Math.PI * ("left" === r.position ? -.5 : .5)), i.save(), i.translate(s, l), i.rotate(p), i.textAlign = "center", i.textBaseline = "middle", i.fillText(r.text, 0, 0, u), i.restore()
                            }
                        }
                    }), {
                        id: "title",
                        ...
                        i = t.Scale.extend({
                            ...
                            getValueForPixel: function (t) {
                                var e = this,
                                    ...
                                    i = e.isHorizontal(),
                                    a = (i ? e.width : e.height) / n;
                                return t -= i ? e.left : e.top, e.options.gridLines.offsetGridLines && (t -= a / 2), t <= 0 ? 0 : Math.round(t / a)
                            },
                            getBasePixel: function () {
                                return this.bottom
                            }
                        ...
                        i = t.Scale.extend({
                            ...
                            getPixelForValue: function (t) {
                                var n, i, a, r = this,
                                    ...
                                    l = r.options,
                                    u = l.ticks;
                                return r.isHorizontal() ? (a = e.log10(r.end) - e.log10(o), 0 === s ? i = r.left : (n = r.width, i = r.left + n / a * (e.log10(s) - e.log10(o)))) : (n = r.height, 0 !== o || u.reverse ? 0 === r.end && u.reverse ? (a = e.log10(r.start) - e.log10(r.minNotZero), i = s === r.end ? r.top : s === r.minNotZero ? r.top + .02 * n : r.top + .02 * n + .98 * n / a * (e.log10(s) - e.log10(r.minNotZero))) : 0 === s ? i = u.reverse ? r.top : r.bottom : (a = e.log10(r.end) - e.log10(o), n = r.height, i = r.bottom - n / a * (e.log10(s) - e.log10(o))) : (a = e.log10(r.end) - e.log10(r.minNotZero), i = s === o ? r.bottom : s === r.minNotZero ? r.bottom - .02 * n : r.bottom - .02 * n - .98 * n / a * (e.log10(s) - e.log10(r.minNotZero)))), i
                            },
                            getValueForPixel: function (t) {
                                var n, i, a = this,
                ...
                e.exports = function (t) {
                    ...
                    function n(t) {
                        var e = t.options.pointLabels,
                            ...
                            a = f.getValueOrDefault(e.fontFamily, p.defaultFontFamily);
                        return {
                            size: n,
                            style: i,
                            family: a,
                            font: f.fontString(n, i, a)
                        }
                    }
                    ...
                    function d(t) {
                        ...
                        for (var g = e(t) - 1; g >= 0; g--) {
                            ...
                            if (d.display) {
                                var v = t.getPointPosition(g, c + 5),
                                    ...
                                    f.each(t.ticks, function (s, l) {
                                        if (l > 0 || e.reverse) {
                                            ...
                                            if (n.display && 0 !== l && c(t, n, d, l), i.display) {
                                                var f = a(i.fontColor, p.defaultFontColor);
                ...
                i = "function" == typeof i ? i : window.moment, e.exports = function (t) {
                    ...
                    function a(t, e, n, i) {
                        ...
                        if (a.steps)
                            ...
                            for (; o > i && i > 0;) ++l, o = Math.ceil(u / (r * l));
                        return l
                    }
                    ...
                    var u = t.Scale.extend({
                        ...
                        determineDataLimits: function () {
                            ...
                            o.each(s.labels, function (o, s) {
                                ...
                                var d = [];
                                "object" == typeof s.data[0] && null !== s.data[0] && n.chart.isDatasetVisible(u) ? o.each(s.data, function (o, s) {
                        ...
                        buildTicks: function () {
                            ...
                            var p = l.stepSize || a(i || u, r || d, f, h);
                        ...
                        getLabelWidth: function (e) {
                            ...
                            return a * r + o.getValueOrDefault(i.fontSize, t.defaults.global.defaultFontSize) * s
                        },
...
WOW.prototype._initStorageVariables = function () {
        ...
        for (var e = document.getElementsByClassName(this._boxClass), n = 0; n < e.length; n++) ! function (n) {
            t(e[n], n)
        }(n)
    }, WOW.prototype._prepareBox = function (t) {
        var e = this._boxes.push(t) - 1;
        this._animation[e] = {
            animationName: t.style.animationName || window.getComputedStyle(t, null).animationName
        }, t.style.animationName = "none", t.style.visibility = "hidden"
        ...
        t.className.indexOf(this._animateClass) === -1 && (delete this._boxes[e], this._onStartAnimation(t, e), this._onStopAnimation(t, e), this._animate(t, e, this._getAnimationConfig(t)))
        ...
        var e = t.getAttribute("data-wow-offset") || this._offset,
            ...
            i = n + ~~e;
        return i <= window.innerHeight + window.scrollY && (0 === i ? 10 : i) >= window.scrollY
        ...
        t.forEach(function (t) {
            for (var e = 0; e < t.addedNodes.length; e++) this.doSync(t.addedNodes[e])
        }.bind(this))
    ...
    function (t, e) {
        ...
        function a(t) {
            var e = h.call(t);
            return "[object String]" === e ? c(t) : n(t) && /^\[object (Array|HTMLCollection|NodeList|Object)\]$/.test(e) && t.hasOwnProperty("length") ? t : i(t) ? [t] : []
        }
        ...
        function r(t) {
            var n, i, a = {
                ...
                r = t && t.ownerDocument;
            return n = r.documentElement, void 0 !== t.getBoundingClientRect && (a = t.getBoundingClientRect()), i = e(r), {
            ...
            if (null !== e) {
                ...
                if (m.registerEvent(t), "touchstart" === t.type && p.delay) {
                    var n = !1,
                        ...
                        a = function (a) {
                            i && (clearTimeout(i), i = null, p.show(t, e)), n || (n = !0, p.hide(a, e))
                        },
                        r = function (t) {
                            i && (clearTimeout(i), i = null), a(t)
                        };
            ...
            p = {
                ...
                show: function (t, e, n) {
                    ...
                    var a = r(e),
                        s = 0,
                        l = 0;
                    "touches" in t && t.touches.length ? (s = t.touches[0].pageY - a.top, l = t.touches[0].pageX - a.left) : (s = t.pageY - a.top, l = t.pageX - a.left), l = l >= 0 ? l : 0, s = s >= 0 ? s : 0;
                    var u = "scale(" + e.clientWidth / 100 * 3 + ")",
                        d = "translate(0,0)";
                    n && (d = "translate(" + n.x + "px, " + n.y + "px)"), i.setAttribute("data-hold", Date.now()), i.setAttribute("data-x", l), i.setAttribute("data-y", s), i.setAttribute("data-scale", u), i.setAttribute("data-translate", d);
                    var c = {
                        top: s + "px",
                        left: l + "px"
                    };
                    i.classList.add("waves-notransition"), i.setAttribute("style", o(c)), i.classList.remove("waves-notransition"), c["-webkit-transform"] = u + " " + d, c["-moz-transform"] = u + " " + d, c["-ms-transform"] = u + " " + d, c["-o-transform"] = u + " " + d, c.transform = u + " " + d, c.opacity = "1";
                    var h = "mousemove" === t.type ? 2500 : p.duration;
                    c["-webkit-transition-duration"] = h + "ms", c["-moz-transition-duration"] = h + "ms", c["-o-transition-duration"] = h + "ms", c["transition-duration"] = h + "ms", i.setAttribute("style", o(c))
                },
                hide: function (t, e) {
                    e = e || this;
                    for (var n = e.getElementsByClassName("waves-rippling"), i = 0, a = n.length; i < a; i++) s(t, e, n[i])
                }
            },
            g = {
                input: function (t) {
        ...
        return d.init = function (t) {
            var e = document.body;
            t = t || {}, "duration" in t && (p.duration = t.duration), "delay" in t && (p.delay = t.delay), f && (e.addEventListener("touchstart", u, !1), e.addEventListener("touchcancel", m.registerEvent, !1), e.addEventListener("touchend", m.registerEvent, !1)), e.addEventListener("mousedown", u, !1)
        }, d.attach = function (t, e) {
            t = a(t), "[object Array]" === h.call(e) && (e = e.join(" ")), e = e ? " " + e : "";
            for (var n, i, r = 0, o = t.length; r < o; r++) n = t[r], i = n.tagName.toLowerCase(), ["input", "img"].indexOf(i) !== -1 && (g[i](n), n = n.parentElement), n.className.indexOf("waves-effect") === -1 && (n.className += " waves-effect" + e)
        }, d.ripple = function (t, e) {
            t = a(t);
            var n = t.length;
            if (e = e || {}, e.wait = e.wait || 0, e.position = e.position || null, n)
                for (var i, o, s, l = {}, u = 0, d = {
                        type: "mousedown",
                        button: 1
                    }; u < n; u++)
                    if (i = t[u], o = e.position || {
                            x: i.clientWidth / 2,
                            y: i.clientHeight / 2
                        }, s = r(i), l.x = s.left + o.x, l.y = s.top + o.y, d.pageX = l.x, d.pageY = l.y, p.show(d, i), e.wait >= 0 && null !== e.wait) {
                        var c = {
                            type: "mouseup",
                            button: 1
                        };
            ...
            console.error("Waves.displayEffect() has been deprecated and will be removed in future version. Please use Waves.init() to initialize Waves effect"), d.init(t)
        }, d
    ...
    function (t) {
        t(document).ready(function () {
                ...
                a = function () {
                    ...
                    if (e.val().length) {
                        var n = t(".hiddendiv"),
                            i = e.css("font-family"),
                            a = e.css("font-size");
                        a && hiddenDiv.css("font-size", a), i && hiddenDiv.css("font-family", i), "off" === e.attr("wrap") && hiddenDiv.css("overflow-wrap", "normal").css("white-space", "pre"), n.text(e.val() + "\n");
            ...
            t(e).each(function (e, i) {
                ...
                a && r && o && n.siblings("label, i").removeClass("active"), i(n)
